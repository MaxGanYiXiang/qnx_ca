...
//NOTE: other functions will be after main()
void create_wave()
{
    int samplesPerCycle;
    int halfCycle;
...
//=====================Threads==========================
void *get_param(void *arg) //thread that continuously check for user input
{
    char input[200];
    char w;
    double f;
    ...
    printf("|   -p : Play back recorded data          |\n");
    ...
    printf("|        sine, 2.5V                       |\n");
    printf("|\n");
    printf("| 2. Output to DAC (-w):                  |\n");
    printf("|    Ex: ./wavegen -w file.wave           |\n");
    printf("|\n");
    printf("| 3. Record ADC Data (-i):                |\n");
    printf("|    Ex: ./wavegen -i pot_data.wave       |\n");
    printf("|\n");
    printf("| 4. Playback Data (-p):                  |\n");
    printf("|    Ex: ./wavegen -p pot_data.wave       |\n");
    printf("|\n");
    printf("| 5. Run: Set digital input to 0xF0       |\n");
    printf("|\n");
